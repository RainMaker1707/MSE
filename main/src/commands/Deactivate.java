...
public class Deactivate implements Command {
    ...
    public Deactivate(String name, List<Context> contexts, List<Feature> features, String command){
    ...
    public List<String> getArguments() {
        ...
        for(String s: command.split(" ")) if(!s.equals(keyword)) arguments.add(s);
        return arguments;
    }
